...
def display_movies_customer_rated_higher_than(df, customer_id, min_rating=4):
    ...
    all_customers_average_ratings =  all_average_ratings(df=df, type='customer_id')
    print('average rating', get_item_avg_rating(df=all_customers_average_ratings, type='customer_id', id=customer_id))
